...
FOUNDRY_PROFILE=docs forge doc --out tmp/technical-docs
...
tail -n +5 tmp/technical-docs/src/SUMMARY.md >> docs/src/SUMMARY.md
...
cp -R tmp/technical-docs/src/solidity/interfaces docs/src/solidity/
