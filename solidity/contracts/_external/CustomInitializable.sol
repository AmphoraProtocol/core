 ...
 * ====
 */
// TODO: This is a temporary solution, we will remove the contracts
abstract contract CustomInitializable {
  ...
  modifier initializer2() {
    ...
    bool _isTopLevelCall = !_initializing;
    if (_isTopLevelCall) {
      _initializing = true;
      _initialized = true;
    }
    ...
    if (_isTopLevelCall) _initializing = false;
  }
  /**
