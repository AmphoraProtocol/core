...
import {IGovernorCharlieDelegator, GovernorCharlieEvents} from '@interfaces/governance/IGovernor.sol';
import {GovernorCharlieDelegatorStorage} from '@contracts/governance/GovernorStorage.sol';

contract GovernorCharlieDelegator is
    GovernorCharlieDelegatorStorage,
    GovernorCharlieEvents,
    IGovernorCharlieDelegator
{
    constructor(address amph_, address implementation_) {
        delegateTo(implementation_, abi.encodeWithSignature('initialize(address)', amph_));
