...
interface IUSDA is IERC20Metadata {
    ...
    // business
    function deposit(uint256 susd_amount) external;

    function depositTo(uint256 susd_amount, address target) external;

    function withdraw(uint256 susd_amount) external;

    function withdrawTo(uint256 susd_amount, address target) external;

    function withdrawAll() external;

    function withdrawAllTo(address target) external;

    function donate(uint256 susd_amount) external;
    ...
    function mint(uint256 susd_amount) external;

    function burn(uint256 susd_amount) external;
    ...
    function vaultControllerTransfer(address target, uint256 susd_amount) external;
